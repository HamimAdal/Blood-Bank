<?php
    ...
    //Create INSERT query
    $qry = "INSERT INTO book_details(book_name, book_description, available, book_price, book_photo, book_category) VALUES('$name','$description',$available,'$price','$photo','$category')";
