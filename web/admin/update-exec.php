 ...
 //Function to sanitize values received from the form. Prevents SQL injection
	...
	$ConfirmNewPassword = clean($_POST['cpassword']);
     ...
     if (isset($_GET['id']))
     {
         ...
         // update the entry
         $result = mysql_query("UPDATE admin_login SET Password='$NewPassword' WHERE Admin_ID='$id' AND Password='$OldPassword'")
         or die("The admin does not exist ... \n". mysql_error());

		if($result){
			echo "<html><script language='JavaScript'>alert('Password Changed successifully.')</script></html>";
