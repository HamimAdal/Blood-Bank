...
public class sbr extends Activity {
    ...
    protected void showList(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    sbr.this, personList, R.layout.list_item,
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String>{
            ...
            protected String doInBackground(String... params) {
                ...
                HttpPost httppost = new HttpPost("http://mistcse.eu.pn/get-data.php");
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING:
                    // phone ringing...
                    Toast.makeText(sbr.this, incomingNumber + " calls you",
                            Toast.LENGTH_LONG).show();
                    break;

                case TelephonyManager.CALL_STATE_OFFHOOK:
                    // one call exists that is dialing, active, or on hold
                    Toast.makeText(sbr.this, "on call...",
                            Toast.LENGTH_LONG).show();
                ...
                case TelephonyManager.CALL_STATE_IDLE:
                    ...
                    if (onCall == true) {
                        Toast.makeText(sbr.this, "restart app after call",
                                Toast.LENGTH_LONG).show();
